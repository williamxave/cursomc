...
public class Cliente implements Serializable {
	...
	@Column(unique = true) // Nao deixa ter dois email igual, mas precisa criar exception personalizada
	...
	/*
	 * A classe enum foi implementada, mas guardar uma string assim no banco não é
	 * legal, entao demos valores inteiros para os enums 1 para Pessoa Fisica e 2
	 * para Pessoa Juridica, Como atributo o tipo é integer, os get e seters foram
	 * mudados, para que ficassem tudo sobre nosso controle. No get temos um metodos
	 * aplicado para que retorne apenas o tipo da pessoas, metodo esse criado na
	 * classe enum
	 * 
	 */
